...
public class ScancafResource {
    ...
    public ScancafResource(ScancafRepository scancafRepository, ScancafSearchRepository scancafSearchRepository,BoxassignRepository boxassignRepository) {
     ...
     *
     * @param scancaf the scancaf to create
     * @return the ResponseEntity with status 201 (Created) and with body the new scancaf, or with status 400 (Bad Request) if the scancaf has already an ID
    ...
    public ResponseEntity<Scancaf> createScancaf(@RequestBody Scancaf scancaf) throws URISyntaxException {
        ...
        if (scancaf.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new scancaf cannot already have an ID")).body(null);
        }
     ...
     *
     * @param scancaf the scancaf to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated scancaf,
     * or with status 400 (Bad Request) if the scancaf is not valid,
     * or with status 500 (Internal Server Error) if the scancaf couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/scancafs")
    @Timed
    public ResponseEntity<Scancaf> updateScancaf(@RequestBody Scancaf scancaf) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, scancaf.getId().toString()))
            .body(result);
    }
     ...
     * @return the ResponseEntity with status 200 (OK) and the list of scancafs in body
     */
    @GetMapping("/scancafs")
    @Timed
     ...
     *
     * @param id the id of the scancaf to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the scancaf, or with status 404 (Not Found)
     */
     ...
     *
     * @param id the id of the scancaf to delete
     ...
     * to the query.
     *
     * @param query the query of the scancaf search
     * @param pageable the pagination information
    ...
    public ResponseEntity<Scancaf> getBox(@RequestBody Scancaf id) {
        ...
        return ResponseEntity.ok().body(scancaf);
        	...
        	return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "Caf is Not segregated")).body(null);
        }
