(function() {
    ...
    function ScancafDialogController($timeout, $scope, $stateParams, $uibModalInstance, entity, Scancaf, $cookies, $cookieStore) {
        ...
        $scope.$watch('vm.scancaf.sourcebox', function () {
            if (vm.scancaf.sourcebox.length === 8) Scancaf.getSource(vm.scancaf.sourcebox, onSaveSuccess);
        ...
        $scope.validate1 = function () {
            ...
            if (vm.scancaf.category1.length === 8 && vm.scancaf.category1.substring(0, 3) !== 'EDA') {
                alert('Assigned Box in Category 1 is not correct !!! Please Check')
            }
            if (vm.scancaf.category2.length === 8 && vm.scancaf.category2.substring(0, 3) !== 'E1A') {
                alert('Assigned Box in Category 2 is not correct !!! Please Check')
            }
            if (vm.scancaf.category3.length === 8 && vm.scancaf.category3.substring(0, 3) !== 'EC1') {
                alert('Assigned Box in Category 3 is not correct !!! Please Check')
            }
            if (vm.scancaf.category4.length === 8 && vm.scancaf.category4.substring(0, 3) !== 'EC2') {
                alert('Assigned Box in Category 4 is not correct !!! Please Check')
            }
            if (vm.scancaf.category5.length === 8 && vm.scancaf.category5.substring(0, 3) !== 'EC3') {
