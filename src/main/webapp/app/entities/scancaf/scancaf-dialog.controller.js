           ...
           function onSaveSuccess1 (result) {
	           ...
	           if(vm.scancaf.countCategory1===300){
          			...
          			$cookieStore.put('completed', vm.scancaf.category1);
          				...
          				vm.scancaf.category1 = Scancaf.findCategory1(onSucess);
        	 ...
        	 if(vm.scancaf.boxstatus!=null){
        		 ...
        		 if(vm.scancaf.countCategory1===50|| vm.scancaf.countCategory1===100||vm.scancaf.countCategory1===150||
                  ...
                  vm.scancaf.category = result.category;
                   vm.scancaf.category= 'E1A'+increment_alphanumeric_str(vm.scancaf.category.substring(3, 8));
                    }

        		 if(vm.scancaf.countCategory5===50|| vm.scancaf.countCategory5===100||vm.scancaf.countCategory5===150||
        				 vm.scancaf.countCategory5===200|| vm.scancaf.countCategory5===250||vm.scancaf.countCategory5===300||
        				 vm.scancaf.countCategory5===350||vm.scancaf.countCategory5===400||
        				 vm.scancaf.countCategory5===450|| vm.scancaf.countCategory5===500||vm.scancaf.countCategory5===550||
        				 vm.scancaf.countCategory5===600||vm.scancaf.countCategory5===650||
        				 vm.scancaf.countCategory5===700|| vm.scancaf.countCategory5===750||vm.scancaf.countCategory5===800||
        				 vm.scancaf.countCategory5===850||vm.scancaf.countCategory5===900||
        				 vm.scancaf.countCategory5===950|| vm.scancaf.countCategory5===1000||vm.scancaf.countCategory5===1050||
        				 vm.scancaf.countCategory5===1100||vm.scancaf.countCategory5===1150||
        				 vm.scancaf.countCategory5===1200|| vm.scancaf.countCategory5===1250||vm.scancaf.countCategory5===1300||
        				 vm.scancaf.countCategory5===1350||vm.scancaf.countCategory5===1400||
        				 vm.scancaf.countCategory5===1450|| vm.scancaf.countCategory5===1500
        				 || vm.scancaf.countCategory5===1550){
        			 alert('For Category5 : Lot is completed') ;
        			 Scancaf.findCategory5(onSuccessCategory5);

        			  function onSuccessCategory5(result){
                                        vm.scancaf.category5 = result.category5;
                                         vm.scancaf.category5= 'EDA'+increment_alphanumeric_str(vm.scancaf.category5.substring(3, 8));
                                        }
         		 }
        		 ...
        		 function onSaveSuccessFinal() {
           		  ...
           		  if(vm.scancaf.countCategory1===800){
           			  $cookieStore.put('completed', vm.scancaf.category2);
           			  vm.scancaf.countCategory2= 0;
           			   Scancaf.findCategory2(onSuccessCategory2);

                        function onSuccessCategory2(result){
                          vm.scancaf.category2 = result.category2;
                          vm.scancaf.category2= 'EC1'+increment_alphanumeric_str(vm.scancaf.category2.substring(3, 8));
                           }
           		  ...
           		  if(vm.scancaf.countCategory3===300){
           			$cookieStore.put('completed', vm.scancaf.category3);
         			  vm.scancaf.countCategory3= 0;
         			  Scancaf.findCategory3(onSuccessCategory3);

                                             function onSuccessCategory3(result){
                                               vm.scancaf.category3 = result.category3;
                                               vm.scancaf.category3= 'EC2'+increment_alphanumeric_str(vm.scancaf.category3.substring(3, 8));
                                                }
           		  ...
           		  if(vm.scancaf.countCategory4===300){
           			$cookieStore.put('completed', vm.scancaf.category4);
       			  vm.scancaf.countCategory4= 0;
       			  Scancaf.findCategory4(onSuccessCategory4);
